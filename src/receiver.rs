...
async fn main() -> Result<(), Error> {
    ...
    set_on_track_handler(&peer_connection, notify_rx, tx_decoder_1, shutdown.clone());
    ...
    set_on_ice_connection_state_change_handler(&peer_connection, notify_tx, shutdown.clone());
